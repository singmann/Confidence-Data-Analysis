...
## --------------------------------------------------------------------------------------------------
adler_2018_ex3 <- read_csv(file.path(data_path, "data_Adler_2018_Expt3.csv")) |>
  mutate(dataset = "Adler_2018_Ex3")

adler_2018_ex3 <- adler_2018_ex3 |>
  mutate(
    status = if_else(Stimulus == 2, "signal", "noise"),
...
adler_2018_ex3_plot <- adler_2018_ex3 |>
  ...
  filter(conf != "1") |>
  mutate(category = "Cognitive")


## --------------------------------------------------------------------------------------------------
chandravadia_2020 <- read_csv(file.path(
  data_path,
  "data_Chandravadia_2020.csv"
)) |>
  mutate(dataset = "Chandravadia_2020")

chandravadia_2020 <- chandravadia_2020 |>
  mutate(
    status = if_else(Stimulus == 1, "signal", "noise"),
...
chandravadia_2020_plot <- chandravadia_2020 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory")


## --------------------------------------------------------------------------------------------------
desender_2022_p2B <- read_csv(file.path(
  data_path,
  "data_Desender_2022_Exp2B.csv"
)) |>
  mutate(dataset = "Desender_2022_p2B")

desender_2022_p2B <- desender_2022_p2B |>
  mutate(
    status = if_else(Stimulus == 0, "signal", "noise"),
...
desender_2022_p2B_plot <- desender_2022_p2B |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception")


## --------------------------------------------------------------------------------------------------
gajdos_2019 <- read_csv(file.path(data_path, "data_Gajdos_2019.csv")) |>
  mutate(dataset = "Gajdos_2019") |>
  filter(!is.na(Confidence), !is.na(Response))
...
## --------------------------------------------------------------------------------------------------
gherman_2018 <- read_csv(file.path(data_path, "data_Gherman_2018.csv")) |>
  mutate(dataset = "Gherman_2018")
...
## --------------------------------------------------------------------------------------------------
hu_2017 <- read_csv(file.path(data_path, "data_Hu_2017.csv")) |>
  mutate(dataset = "Hu_2017")
...
## --------------------------------------------------------------------------------------------------
jachs_2015_ex1 <- read_csv(file.path(data_path, "data_Jachs_2015_Exp1.csv")) |>
  mutate(dataset = "Jachs_2015_Ex1")
...
## --------------------------------------------------------------------------------------------------
jachs_2015_ex2 <- read_csv(file.path(data_path, "data_Jachs_2015_Exp2.csv")) |>
  mutate(dataset = "Jachs_2015_Ex2")
...
## --------------------------------------------------------------------------------------------------
jachs_2015_ex3 <- read_csv(file.path(data_path, "data_Jachs_2015_Exp3.csv")) |>
  mutate(dataset = "Jachs_2015_Ex3")
...
## --------------------------------------------------------------------------------------------------
kantner_2012_ex1 <- read_csv(file.path(
  data_path,
  "data_Kantner_2012_E1.csv"
)) |>
  mutate(dataset = "Kantner_2012_Ex1")
...
## --------------------------------------------------------------------------------------------------
kantner_2012_ex2 <- read_csv(file.path(
  data_path,
  "data_Kantner_2012_E2.csv"
)) |>
  mutate(dataset = "Kantner_2012_Ex2")
...
## --------------------------------------------------------------------------------------------------
kantner_2012_ex4 <- read_csv(file.path(
  data_path,
  "data_Kantner_2012_E4.csv"
)) |>
  mutate(dataset = "Kantner_2012_Ex4")
...
## --------------------------------------------------------------------------------------------------
kantner_2014_ex1 <- read_csv(file.path(
  data_path,
  "data_Kantner_2014_E1.csv"
)) |>
  mutate(dataset = "Kantner_2014_Ex1")
...
## --------------------------------------------------------------------------------------------------
kantner_2014_ex2 <- read_csv(file.path(
  data_path,
  "data_Kantner_2014_E2.csv"
)) |>
  mutate(dataset = "Kantner_2014_Ex2")
...
## --------------------------------------------------------------------------------------------------
maniscalco_2017_ex1 <- read_csv(file.path(
  data_path,
  "data_Maniscalco_2017_expt1.csv"
)) |>
  mutate(dataset = "Maniscalco_2017_Ex1") |>
  filter(!is.na(Confidence), !is.na(Response))
...
## --------------------------------------------------------------------------------------------------
rouault_2018_ex2 <- read_csv(file.path(
  data_path,
  "data_Rouault_2018_Expt2.csv"
)) |>
  mutate(dataset = "Rouault_2018_Ex2")
...
## --------------------------------------------------------------------------------------------------
lindsay_2014 <- read_csv(file.path(data_path, "data_Lindsay_2014.csv")) |>
  mutate(dataset = "Lindsay_2014")
...
## --------------------------------------------------------------------------------------------------
maniscalco_2017_ex3 <- read_csv(file.path(
  data_path,
  "data_Maniscalco_2017_expt3.csv"
)) |>
  mutate(dataset = "Maniscalco_2017_Ex3") |>
  filter(ConfCollected == 1, !is.na(Confidence))
...
## --------------------------------------------------------------------------------------------------
sinanaj_2015 <- read_csv(file.path(data_path, "data_Sinanaj_2015.csv")) |>
  mutate(dataset = "Sinanaj_2015")
...
## --------------------------------------------------------------------------------------------------
song_2011 <- read_csv(file.path(data_path, "data_Song_2011.csv")) |>
  mutate(dataset = "Song_2011") |>
  filter(!is.na(Confidence), !is.na(Response))
...
## --------------------------------------------------------------------------------------------------
adler_2018_ex1 <- read_csv(file.path(data_path, "data_Adler_2018_Expt1.csv")) |>
  mutate(dataset = "Adler_2018_Ex1")
...
adler_2018_ex1_A_plot <- adler_2018_ex1_A |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "A")
...
adler_2018_ex1_B_plot <- adler_2018_ex1_B |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "B")

adler_2018_ex1_plots <- bind_rows(adler_2018_ex1_A_plot, adler_2018_ex1_B_plot)


## --------------------------------------------------------------------------------------------------
adler_2018_ex2 <- read_csv(file.path(data_path, "data_Adler_2018_Expt2.csv")) |>
  mutate(dataset = "Adler_2018_Ex2")
...
## --------------------------------------------------------------------------------------------------
bang_2019_exp1 <- read_csv(file.path(data_path, "data_Bang_2019_Exp1.csv")) |>
  mutate(dataset = "Bang_2019_Ex1")
...
bang_2019_exp1_cond1_plot <- bang_2019_exp1_cond1 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "1")
...
bang_2019_exp1_cond2_plot <- bang_2019_exp1_cond2 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "2")
...
bang_2019_exp1_cond3_plot <- bang_2019_exp1_cond3 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "3")

bang_2019_ex1_plots <- bind_rows(
  bang_2019_exp1_cond1_plot,
  bang_2019_exp1_cond2_plot,
  bang_2019_exp1_cond3_plot
)


## --------------------------------------------------------------------------------------------------
bang_2019_exp2 <- read_csv(file.path(data_path, "data_Bang_2019_Exp2.csv")) |>
  mutate(dataset = "Bang_2019_Ex2")
...
bang_2019_ex2_plots <- bind_rows(
  bang_2019_exp2_task1_plot,
  bang_2019_exp2_task2_plot
)


## --------------------------------------------------------------------------------------------------
clark_2018 <- read_csv(file.path(data_path, "data_Clark_2018.csv")) |>
  mutate(dataset = "Clark_2018") |>
...
clark_2018_plots <- bind_rows(
  clark_2018_task1_plot,
  clark_2018_task2_plot,
  clark_2018_task3_plot
)


## --------------------------------------------------------------------------------------------------
denison_2018 <- read_csv(file.path(data_path, "data_Denison_2018.csv")) |>
  mutate(dataset = "Denison_2018")
...
denison_2018_1_plot <- denison_2018_1 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "1")
...
denison_2018_2_plot <- denison_2018_2 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "2")
...
denison_2018_3_plot <- denison_2018_3 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "3")

denison_2018_plots <- bind_rows(
  denison_2018_1_plot,
  denison_2018_2_plot,
  denison_2018_3_plot
)
...
## --------------------------------------------------------------------------------------------------
desender_2022_ex1 <- read_csv(file.path(
  data_path,
  "data_Desender_2022_Exp1.csv"
)) |>
  mutate(dataset = "Desender_2022_Ex1") |>
  filter(!is.na(Confidence))
...
desender_2022_ex1_speed_plot <- desender_2022_ex1_speed |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "speed")
...
desender_2022_ex1_accuracy_plot <- desender_2022_ex1_accuracy |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "accuracy")

desender_2022_ex1_plots <- bind_rows(
  desender_2022_ex1_accuracy_plot,
  desender_2022_ex1_speed_plot
)


## --------------------------------------------------------------------------------------------------
haddara_2022_ex1 <- read_csv(file.path(
  data_path,
  "data_Haddara_2022_Expt1.csv"
)) |>
  mutate(dataset = "Haddara_2022_Ex1")
...
haddara_2022_ex1_plots <- bind_rows(
  haddara_2022_ex1_task1_plot,
  haddara_2022_ex1_task2_plot
)


## --------------------------------------------------------------------------------------------------
haddara_2022_ex2 <- read_csv(file.path(
  data_path,
  "data_Haddara_2022_Expt2.csv"
)) |>
  mutate(dataset = "Haddara_2022_Ex2")
...
haddara_2022_ex2_nf_plot <- haddara_2022_ex2_nf |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "0")

haddara_2022_ex2_plots <- bind_rows(
  haddara_2022_ex2_f_plot,
...
mazor_2020_disc <- mazor_2020 |>
  ...
  mutate(dataset = "Mazor_2020_disc")
...
mazor_2020_detect <- mazor_2020 |>
  ...
  mutate(dataset = "Mazor_2020_detect")
...
## --------------------------------------------------------------------------------------------------
rausch_2020 <- read_csv(file.path(data_path, "data_Rausch_2020.csv")) |>
  mutate(dataset = "Rausch_2020")
...
rausch_2020_soa1_plot <- rausch_2020_soa1 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "16.7")
...
rausch_2020_soa2_plot <- rausch_2020_soa2 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "33.3")
...
rausch_2020_soa3_plot <- rausch_2020_soa3 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "66.7")


rausch_2020_plots <- bind_rows(
  rausch_2020_soa1_plot,
...
## --------------------------------------------------------------------------------------------------
sadeghi_2017_memory <- read_csv(file.path(
  data_path,
  "data_Sadeghi_2017_memory.csv"
)) |>
  mutate(dataset = "Sadeghi_2017_Memory")
...
sadeghi_2017_memory_p_plot <- sadeghi_2017_memory_p |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "patient")
...
sadeghi_2017_memory_c_plot <- sadeghi_2017_memory_c |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "control")

sadeghi_2017_memory_plots <- bind_rows(
  sadeghi_2017_memory_p_plot,
  sadeghi_2017_memory_c_plot
)


## --------------------------------------------------------------------------------------------------
sadeghi_2017_perception <- read_csv(file.path(
  data_path,
  "data_Sadeghi_2017_perception.csv"
)) |>
  mutate(dataset = "Sadeghi_2017_Perception")
...
sadeghi_2017_perception_p_plot <- sadeghi_2017_perception_p |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "patient")
...
sadeghi_2017_perception_c_plot <- sadeghi_2017_perception_c |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "control")

sadeghi_2017_perception_plots <- bind_rows(
  sadeghi_2017_perception_p_plot,
  sadeghi_2017_perception_c_plot
)


## --------------------------------------------------------------------------------------------------
shekhar_2018 <- read_csv(file.path(data_path, "data_Shekhar_2018.csv")) |>
  mutate(dataset = "Shekhar_2018")
...
shekhar_2018_s1_plot <- shekhar_2018_s1 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "S1")
...
shekhar_2018_dlpfc_plot <- shekhar_2018_dlpfc |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "DLPFC")
...
shekhar_2018_apfc_plot <- shekhar_2018_apfc |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "aPFC")

shekhar_2018_plots <- bind_rows(
  shekhar_2018_s1_plot,
...
## --------------------------------------------------------------------------------------------------
sherman_2016_jocn <- read_csv(file.path(
  data_path,
  "data_Sherman_2016_JOCN.csv"
)) |>
  mutate(dataset = "Sherman_2016_JOCN")
...
sherman_2016_jocn_4_plot <- sherman_2016_jocn_4 |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "4")

sherman_2016_jocn_plots <- bind_rows(
  sherman_2016_jocn_1_plot,
...
## --------------------------------------------------------------------------------------------------
siedlecka_2016 <- read_csv(file.path(data_path, "data_Siedlecka_2016.csv")) |>
  mutate(dataset = "Siedlecka_2016") |>
  filter(!is.na(Confidence), !is.na(Response))
...
siedlecka_2016_plots <- bind_rows(
  siedlecka_2016_1_plot,
...
## --------------------------------------------------------------------------------------------------
siedlecka_2019_1 <- read_csv(file.path(
  data_path,
  "data_Siedlecka_2019_Exp1.csv"
)) |>
  mutate(dataset = "Siedlecka_2019_Ex1") |>
  filter(!is.na(Confidence), !is.na(Response))
...
siedlecka_2019_1_resp_plot <- siedlecka_2019_1_resp |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "0")
...
siedlecka_2019_1_conf_plot <- siedlecka_2019_1_conf |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "1")

siedlecka_2019_1_plots <- bind_rows(
  siedlecka_2019_1_resp_plot,
  siedlecka_2019_1_conf_plot
)


## --------------------------------------------------------------------------------------------------
siedlecka_2019_2 <- read_csv(file.path(
  data_path,
  "data_Siedlecka_2019_Exp2.csv"
)) |>
  mutate(dataset = "Siedlecka_2019_Ex2") |>
  filter(!is.na(Confidence), !is.na(Response))
...
siedlecka_2019_2_plots <- bind_rows(
  siedlecka_2019_2_dec_plot,
  siedlecka_2019_2_conf_plot
)


## --------------------------------------------------------------------------------------------------
skora_2016 <- read_csv(file.path(data_path, "data_Skora_2016.csv")) |>
  mutate(dataset = "Skora_2016") |>
  filter(!is.na(Confidence), !is.na(Response))
...
skora_2016_fm_plot <- skora_2016_fm |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "FM")
...
skora_2016_im_plot <- skora_2016_im |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "IM")
...
skora_2016_wm_plot <- skora_2016_wm |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "WM")

skora_2016_plots <- bind_rows(
  skora_2016_fm_plot,
  skora_2016_im_plot,
  skora_2016_wm_plot
)
...
## --------------------------------------------------------------------------------------------------
xu_2019_ex1 <- read_csv(file.path(data_path, "data_Xu_2019_Exp1.csv")) |>
  mutate(dataset = "Xu_2019_Ex1") |>
  filter(!is.na(Confidence), !is.na(Response))
...
xu_2019_ex1_c_congruent_plot <- xu_2019_ex1_c_congruent |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "congruent")
...
xu_2019_ex1_c_incongruent_plot <- xu_2019_ex1_c_incongruent |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Cognitive", condition = "incongruent")

xu_2019_ex1_c_plots <- bind_rows(
  xu_2019_ex1_c_congruent_plot,
...
xu_2019_ex1_m_congruent_plot <- xu_2019_ex1_m_congruent |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "congruent")
...
xu_2019_ex1_m_incongruent_plot <- xu_2019_ex1_m_incongruent |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Memory", condition = "incongruent")

xu_2019_ex1_m_plots <- bind_rows(
  xu_2019_ex1_m_congruent_plot,
  xu_2019_ex1_m_incongruent_plot
)


## --------------------------------------------------------------------------------------------------
xu_2019_ex2 <- read_csv(file.path(data_path, "data_Xu_2019_Exp2.csv")) |>
  mutate(dataset = "Xu_2019_Ex2") |>
  filter(!is.na(Confidence), !is.na(Response))
...
xu_2019_ex2_c_plots <- bind_rows(
  xu_2019_ex2_c_congruent_plot,
...
xu_2019_ex2_m_plots <- bind_rows(
  xu_2019_ex2_m_congruent_plot,
  xu_2019_ex2_m_incongruent_plot
)


## --------------------------------------------------------------------------------------------------
ye_2018 <- read_csv(file.path(data_path, "data_Ye_2018.csv")) |>
  mutate(dataset = "Ye_2018") |>
  filter(!is.na(Confidence), !is.na(Response))
...
ye_2018_p_precuneus_plot <- ye_2018_p_precuneus |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "precuneus")
...
ye_2018_p_vertex_plot <- ye_2018_p_vertex |>
  ...
  mutate(across(c(noise, signal), cumsum)) |>
  filter(conf != "1") |>
  mutate(category = "Perception", condition = "vertex")

ye_2018_p_plots <- bind_rows(ye_2018_p_precuneus_plot, ye_2018_p_vertex_plot)
